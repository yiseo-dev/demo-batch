...
INSERT INTO batch.BATCH_STEP_EXECUTION_SEQ (ID, UNIQUE_KEY) select * from (select 0 as ID, '0' as UNIQUE_KEY) as tmp where not exists(select * from batch.BATCH_STEP_EXECUTION_SEQ);
...
INSERT INTO batch.BATCH_JOB_EXECUTION_SEQ (ID, UNIQUE_KEY) select * from (select 0 as ID, '0' as UNIQUE_KEY) as tmp where not exists(select * from batch.BATCH_JOB_EXECUTION_SEQ);
...
INSERT INTO batch.BATCH_JOB_SEQ (ID, UNIQUE_KEY) select * from (select 0 as ID, '0' as UNIQUE_KEY) as tmp where not exists(select * from batch.BATCH_JOB_SEQ);
